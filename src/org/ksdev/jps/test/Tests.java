...
public class Tests {
    ...
    static public void testHexArithmetic() {
        Tests.equalHex("hex_add", new Hex(4, 6, -10), new Hex(1, 2, -3).add(new Hex(3, 4, -7)));
        Tests.equalHex("hex_subtract", new Hex(-2, -2, 4), new Hex(1, 2, -3).subtract(new Hex(3, 4, -7)));
    }
    ...
    static public void testHexNeighbor() {
        Tests.equalHex("hex_neighbor", new Hex(1, 2, -3), new Hex(1, 1, -2).neighbor(2));
    }
    ...
    static public void testHexDistance() {
        Tests.equalInt("hex_distance", 7, new Hex(3, 4, -7).distance(new Hex(0, 0, 0)));
    }


    static public void testHexRotateRight() {
        Tests.equalHex("hex_rotate_right", new Hex(1, 2, -3).rotateRight(), new Hex(3, -1, -2));
    }


    static public void testHexRotateLeft() {
        Tests.equalHex("hex_rotate_left", new Hex(1, 2, -3).rotateLeft(), new Hex(-2, 3, -1));
    }
    ...
    static public void testHexRound() {
        ...
        Tests.equalHex("hex_round 1", new Hex(5, 5, -10), new FractionalHex(0.0, 0.0, 0.0).hexLerp(new FractionalHex(10.0, -20.0, 10.0), 0.5).hexRound());
    ...
    static public void testHexLinedraw() {
        Tests.equalHexArray("hex_linedraw", new ArrayList<Hex>() {{
            ...
            add(new Hex(1, 3, -4));
            add(new Hex(1, 4, -5));
        }}, FractionalHex.hexLinedraw(new Hex(0, 0, 0), new Hex(1, 4, -5)));
    }
    ...
    static public void testOffsetFromCube() {
        Tests.equalOffsetcoord("offset_from_cube even-q", new OffsetCoord(1, 3), OffsetCoord.qoffsetFromCube(OffsetCoord.EVEN, new Hex(1, -3, 2)));
        Tests.equalOffsetcoord("offset_from_cube odd-q", new OffsetCoord(1, 2), OffsetCoord.qoffsetFromCube(OffsetCoord.ODD, new Hex(1, -3, 2)));
    }


    static public void testOffsetToCube() {
        Tests.equalHex("offset_to_cube even-", new Hex(1, -3, 2), OffsetCoord.qoffsetToCube(OffsetCoord.EVEN, new OffsetCoord(1, 3)));
        Tests.equalHex("offset_to_cube odd-q", new Hex(1, -3, 2), OffsetCoord.qoffsetToCube(OffsetCoord.ODD, new OffsetCoord(1, 2)));
    }
    ...
    static public void testDoubledFromCube() {
        Tests.equalDoubledcoord("doubled_from_cube doubled-q", new DoubledCoord(1, 5), DoubledCoord.qdoubledFromCube(new Hex(1, -3, 2)));
        Tests.equalDoubledcoord("doubled_from_cube doubled-r", new DoubledCoord(4, 2), DoubledCoord.rdoubledFromCube(new Hex(1, -3, 2)));
    }


    static public void testDoubledToCube() {
        Tests.equalHex("doubled_to_cube doubled-q", new Hex(1, -3, 2), new DoubledCoord(1, 5).qdoubledToCube());
        Tests.equalHex("doubled_to_cube doubled-r", new Hex(1, -3, 2), new DoubledCoord(4, 2).rdoubledToCube());
    }
